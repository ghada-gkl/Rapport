...
\centering
\small
\caption{Comparaison entre la supervision manuelle, SAP Leonardo ML et SAP Joule}
...
Scrum est un framework agile de gestion de projet conçu pour livrer des produits
de manière incrémentale via des sprints courts (1 à 4 semaines). Il repose sur
des rôles définis (Product Owner, Scrum Master, équipe) et des cérémonies
régulières (sprint planning, daily stand-up, rétrospective).

\paragraph{Avantages}
\begin{itemize}[leftmargin=*, label=\textbullet]
  \item \textbf{Livraisons fréquentes :} Incréments fonctionnels à chaque sprint,
        favorisant un retour rapide des parties prenantes.
  \item \textbf{Adaptabilité :} Le backlog produit peut être réordonné à tout moment
        selon l'évolution des besoins.
  \item \textbf{Transparence :} Les cérémonies Scrum favorisent la communication et
        la visibilité sur l'avancement.
\end{itemize}

\paragraph{Limites}
\begin{itemize}[leftmargin=*, label=\textbullet]
  \item \textbf{Inadapté à la Data Science pure :} Scrum ne prévoit pas de phases
        dédiées à l'exploration des données, à la modélisation ou à l'évaluation
        des modèles.
  \item \textbf{Planification difficile :} La nature exploratoire de la data science
        rend difficile la définition d'un backlog et d'une vélocité prévisible.
\end{itemize}
...
\begin{table}[htbp]
  ...
  \resizebox{\textwidth}{!}{%
  \begin{tabular}{>{\bfseries}p{2.8cm} p{3.4cm} p{3.4cm} p{3.4cm} p{3.4cm}}
    \toprule
...
\begin{figure}[htbp]
  ...
  \caption{le processus utilisé le plus fréquemment dans les projets de data science}
  \label{fig:tdsp}
\end{figure}
