...
\begin{figure}[H]
    ...
    \label{fig:SAP JOULE dans les système SAP}
\end{figure}
\begin{table}[H]
\centering
\small
...
Ce chapitre a mis en évidence l'importance stratégique du développement d'un assistant
intelligent de surveillance SAP répondant aux lacunes critiques des approches actuelles.
Grâce à la méthodologie CRISP-DM, le projet vise à transformer la surveillance SAP
réactive en une supervision proactive et contextualisée.
La solution proposée, basée sur une architecture RAG hybride, constitue une réponse
innovante aux limites des outils existants, tout en s'appuyant sur des technologies
open source accessibles et performantes.