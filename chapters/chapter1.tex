...
Ce chapitre a souligné l'importance stratégique de développer une solution d'assistance intelligente pour les consultants SAP BASIS, afin de pallier les limites des méthodes traditionnelles de recherche et d'utilisation de la documentation technique SAP. En utilisant la méthodologie CRISP-DM, le projet a permis de créer une architecture hybride RAG qui combine la recherche vectorielle, l'algorithme BM25, la fusion des résultats par RRF (Reciprocal Rank Fusion), ainsi qu'un mécanisme de reranking. Basée sur la documentation technique SAP, cette solution offre aux consultants BASIS la possibilité d'obtenir rapidement des réponses fiables, pertinentes et sourcées concernant l'état des systèmes SAP et les procédures d'intervention appropriées. L'approche suggérée repose sur des technologies open source performantes, garantissant ainsi une solution solide, accessible et facilement intégrable dans l'environnement.
