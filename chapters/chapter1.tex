...
La solution proposée repose sur l'utilisation de l'intelligence artificielle pour analyser les événements et les messages générés par les environnements SAP. Grâce à cette approche, le système fournit rapidement des explications contextualisées et des pistes de résolution issues de la documentation SAP pour les incidents soumis par l'utilisateur.
...
réel et un panneau d’administration.
...
\begin{figure}[htbp]
  \centering
   \includegraphics[width=0.65\textwidth]{TDSP.png}
...
Le tableau suivant synthétise les principales caractéristiques de chaque méthodologie afin d'en faciliter la comparaison et de justifier le choix adopté dans le cadre de ce projet.
