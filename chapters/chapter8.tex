...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{images/diagramme_classes_rag.png}
\caption{Diagramme de classes --- Tables fondamentales du système RAG (PostgreSQL)}
...
\caption{Diagramme de séquence — cycles complets d'interaction~: initialisation de session, surveillance SAP et chatbot RAG}
