...
\begin{description}[leftmargin=0pt, labelindent=0pt, style=nextline]
  ...
  En s’appuyant sur des documents externes, le RAG réduit significativement les hallucinations et améliore la précision des réponses \cite{ref20}.

  \item[\textbf{Optimisation des coûts}]
  Contrairement à d’autres approches, le RAG ne nécessite pas de réentraînement du modèle, ce qui permet de limiter les coûts tout en conservant ses capacités \cite{ref21}.
