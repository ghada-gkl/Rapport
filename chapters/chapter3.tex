...
% =========================
% INGESTION / PIPELINES (bleu)
% =========================
\node[box, fill=SAPLightBlue, draw=SAPBlue, right=of sap] (pyrfc) {Extraction temps réel\\PyRFC};
\node[box, fill=SAPLightBlue, draw=SAPBlue, right=of help] (scraping) {Pipeline de scraping web};
...
{Documentation\\Guides de configuration\\Spécifications techniques};

\node[box, fill=SAPLightOrange, draw=SAPOrange, right=of batch2] (trouble) 
{Dépannage\\Versions composants\\Problèmes connus\\Solutions};

% =========================
% OUTPUTS (mix bleu/vert)
% =========================
...
{Construction de graphe\\Base vectorielle};
...
\label{fig:sap_pipeline_colored}
\end{figure}
\subsubsection*{CAG (Cache-Augmented Generation) : une amélioration du RAG}
...
\subsubsection*{Fine-Tuning : personnalisation des modèles IA}
...
\end{table}
\subsection{Le choix du RAG pour ce projet}
